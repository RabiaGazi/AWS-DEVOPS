...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.ci6l1fgns38w.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'aws-capstone-charlie-blog' # please enter your s3 bucket name
